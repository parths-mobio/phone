module.exports = {
   ...
   /* ===== Category constants ===== */
    ...
    CATEGORY_ID_CANT_BE_EMPTY: "Category ids can't be empty",
     ...
     GLIMPULSE_DATE_ALREADY_EXIST: "Glimpulse Date already exist",
  ...
  OTP_NOT_SEND_SUCCESSFUL: "Email OTP not send successful",
  OTP_NOT_VERIFY_SUCCESSFUL: "Email OTP not Verify",
  CHECK_PHONE_OTP: "Please check phone number or otp",

  PASSWORD_INCORRECT: "Password is incorrect",
  PASSWORD_UPDATE_SUCCESS: "Password updated successfully",
  PASSWORD_NOT_UPDATED_SUCCESSFULLY: "Password not updated",
